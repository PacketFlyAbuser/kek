...
public class BasicVerifier extends BasicInterpreter
{
    ...
    public BasicValue ternaryOperation(final AbstractInsnNode abstractInsnNode, final BasicValue basicValue, final BasicValue basicValue2, final BasicValue basicValue3) throws AnalyzerException {
        ...
        if (!this.isSubTypeOf(basicValue, obj)) {
            throw new AnalyzerException(abstractInsnNode, "First argument", "a " + obj + " array reference", basicValue);
        }
    ...
    public BasicValue copyOperation(final AbstractInsnNode abstractInsnNode, final BasicValue obj) throws AnalyzerException {
        ...
        switch (abstractInsnNode.getOpcode()) {
            ...
            case 25: {
                if (!obj.isReference()) {
                    throw new AnalyzerException(abstractInsnNode, null, "an object reference", obj);
                }
                return obj;
            }
            case 58: {
                if (!obj.isReference() && !BasicValue.RETURNADDRESS_VALUE.equals(obj)) {
                    throw new AnalyzerException(abstractInsnNode, null, "an object reference or a return address", obj);
                }
                return obj;
            }
            default: {
        ...
        if (!basicValue.equals(obj)) {
            throw new AnalyzerException(abstractInsnNode, null, basicValue, obj);
        }
        return obj;
    }
        ...
        if (opcode == 197) {
            ...
            while (j < list.size()) {
                ...
                if (!this.isSubTypeOf(basicValue, value)) {
                    throw new AnalyzerException(abstractInsnNode, "Argument " + k, value, basicValue);
                }
            }
        }
